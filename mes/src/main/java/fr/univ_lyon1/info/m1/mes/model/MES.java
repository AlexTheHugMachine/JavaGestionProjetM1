...
public class MES {
    ...
    public void createExampleConfiguration() {
        ...
        new Masseur("John Zemmour", this);
        final HealthProfessional w = new HealthProfessional("Jean Who", this);
        final HealthProfessional s = new Dentist("Steven Strange", this);
        new Homeopath("Yuri Hahnemann", this);
