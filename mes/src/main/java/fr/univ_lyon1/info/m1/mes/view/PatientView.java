...
public class PatientView {
    ...
    public PatientView() {
        ...
        // TODO : Bouton qui permet de copier le num de sécu d'un patient. (N'est pas
        // utile pour un patient donc doit être déplacé.)
        final Button bSSID = new Button("📋");
        // bSSID.setOnAction(ActionEvent -> controller.copyPatientSSID());

        // Bouton qui permet de reload la liste des prescriptions. (parragé par le
