...
public class HealthProfessionalRessourceTest {
  ...
  @Test
  void createHealthProfessionalProperlyGivenRequestDto() throws NameAlreadyBoundException {
  ...
  void createHealthProfessionalWithInvalidSpeciality() {
    ...
    try {
      ...
      fail("Should not throw this exception because the id should be unused.");
    } catch (IllegalArgumentException e) {
      assertEquals(IllegalArgumentException.class, e.getClass());
    }
  }
